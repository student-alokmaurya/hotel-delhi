package com.mauryaalok.HotelDelhi.controller;

import com.mauryaalok.HotelDelhi.dto.Response;
import com.mauryaalok.HotelDelhi.service.interfac.IBookingService;
...
public class RoomController {
    ...
    public ResponseEntity<Response> addNewRoom(
        ...
        if(photo == null || photo.isEmpty() || roomType == null || roomPrice == null || roomType.isBlank()){
            ...
            response.setMessage("Please provide for all fields(photo, roomType, roomPrice)");
    ...
    public ResponseEntity<Response> getAvailableRoomsByDateAndType(
        ...
        if(checkInDate == null || roomType == null || roomType.isBlank() || checkOutDate == null){
            Response response = new Response();
            response.setStatusCode(400);
            response.setMessage("Please provide for all fields(checkInDate, roomType, checkOutDate)");
            return ResponseEntity.status(response.getStatusCode()).body(response);
        }
//        Response response = roomService.countUsers();
