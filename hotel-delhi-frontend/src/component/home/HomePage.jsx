        ...
        <div className="home">
            ...
            <section>
                <header className="header-banner">
                    <img src="./images/hotel.webp" alt="Hotel Delhi" className="header-image" />
                    <div className="overlay"></div>
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="hotel-color">Hotel Delhi</span>
                        </h1><br />
            ...
            <h2 className="home-services">Services at <span className="hotel-color">Hotel Delhi</span></h2>
